...
import { Menu, X, Home, Users, BookOpen, UserCheck, Sparkles, Baby, LogOut, Shirt, Zap, Wrench, Wind, Flame, Package, Layers, Hammer, PartyPopper, ChefHat, Paintbrush, Droplets, HardHat, Frame, Square, Key, Leaf, PawPrint, ChevronDown, Phone, Truck, Camera, Wand2, Bug, Cog, Dumbbell, Music2, Car, Shield, Navigation, Soup, Croissant, Gift, Popcorn } from 'lucide-react'
...
const Header = () => {
  ...
  const services = [
    ...
    { icon: <Gift className="w-5 h-5" />, nameKey: 'services.event_equipment_rental', descKey: 'services.event_equipment_rental.desc', serviceKey: 'event-equipment-rental' },
