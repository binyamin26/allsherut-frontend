...
import { Menu, X, Home, Users, Heart, BookOpen, UserCheck, Sparkles, Baby, LogOut, Shirt, Zap, Wrench, Wind, Flame, Package, Layers, Hammer, PartyPopper, ChefHat, Paintbrush, Droplets, HardHat, Frame, Square, Key, Leaf, PawPrint, ChevronDown, Phone, Truck, Camera, Wand2, Bug, Construction } from 'lucide-react'
...
const Header = () => {
  ...
  const services = [
    ...
    { icon: <Construction className="w-5 h-5" />, nameKey: 'services.handyman', descKey: 'services.handyman.desc', href: '/services/handyman' },
