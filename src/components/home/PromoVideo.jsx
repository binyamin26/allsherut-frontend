    ...
    <div ref={containerRef} className="promo-container" style={mobileStyle}>
      ...
      <div className="scene">
        {promoTexts.map((textObj, index) => {
          ...
          const firstSlideDelay = index === 0 ? 2 : 0;
          return (
            <div key={`${index}-${activeSeq}`}>
              <div className="glow-line active" style={{...(isLast ? {margin:'0 auto'} : {}), animationDelay:`${firstSlideDelay + 0.1}s`}}></div>
              <div className={`text-card ${cls}`} style={{animationDelay:`${firstSlideDelay}s`}}>
                <div className="text-main" style={isLast ? {textAlign:'center', margin:'0 auto'} : {}}>
                  {(() => {
                    ...
                    return lines.map((line, li) => (
                      <span key={li} className="text-promo-line" style={{ animationDelay: `${firstSlideDelay + 0.3 + li * 0.5}s` }}>
                        {line}
                      </span>
                    ));
                  })()}
