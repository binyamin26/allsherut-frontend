  ...
  <div className="hero-center-content">
    ...
    <div className="hero-actions-wrapper">
      <div className="hero-buttons-grid">
        <button onClick={() => setCallModal({ open: true, action: 'call' })} className="btn btn-primary btn-large hero-btn">
          <Phone size={18} />
          {t('provider.callNow')}
        </button>
        ...
        <button onClick={() => setCallModal({ open: true, action: 'whatsapp' })} className="btn btn-success btn-large hero-btn">
      ...
      <div className="provider-content">
        <div className="container">
          <div className="main-content">
            ...
            {/* Section: תמונות (cachée si le prestataire n'a aucune photo) */}
            {provider.media?.gallery?.length > 0 && (
