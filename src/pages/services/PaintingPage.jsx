...
const PaintingPage = () => {
  ...
  const [locationFilter, setLocationFilter] = useLocationFilter('painting');
  ...
  jsonLd={buildServicePageJsonLd({ serviceId: 'painting', name: t('services.painting.pageTitle', SERVICE_PAGE_META.painting.title), description: t('services.painting.desc', SERVICE_PAGE_META.painting.description), t })}
      ...
      <section className="service-header">
        <div className="container">
          ...
          <ServiceHeaderSubtitle serviceId="painting" />
        </div>
      </section>
            ...
            <div className="results-info">
             ...
             <div className="loading-text">{t('services.painting.searching')}</div>
                ...
                <div className="results-count">
                 <strong>{specialty ? filteredProviders.length : resultsCount}</strong> {t('services.painting.found')}
