...
const MechanicPage = () => {
  ...
  const [locationFilter, setLocationFilter] = useLocationFilter('mechanic');
  ...
  const loadProviders = async () => {
    ...
    setError(null);
    try {
      const searchParams = { service: 'mechanic', ...locationFilter, ...activeFilters, page: 1, limit: 100 };
      ...
      if (response.success) {
        ...
        setError(t('services.mechanic.loadError'));
        setProviders([]);
        setResultsCount(0);
      }
    } catch (err) {
  ...
  return (
    <div className="service-page mechanic-page">
      <SEO
  title={t('services.mechanic.pageTitle', SERVICE_PAGE_META.mechanic.title)}
  description={t('services.mechanic.desc', SERVICE_PAGE_META.mechanic.description)}
  canonicalPath={buildServicePath(serviceTypeToKey('mechanic'), 'he')}
  jsonLd={buildServicePageJsonLd({ serviceId: 'mechanic', name: t('services.mechanic.pageTitle', SERVICE_PAGE_META.mechanic.title), description: t('services.mechanic.desc', SERVICE_PAGE_META.mechanic.description), t })}
      />
      ...
      <section className="service-header">
        <div className="container">
          ...
          <ServiceHeaderSubtitle serviceId="mechanic" />
        </div>
      </section>
        ...
        <div className="results-container">
          <div className="results-summary">
            <div className="results-info">
              {loading ? (
                <div className="loading-text">{t('services.mechanic.searching')}</div>
              ) : error ? (
          ...
          {loading ? (
            <div className="providers-loading">
              ...
              <p>{t('services.mechanic.loading')}</p>
            </div>
          ) : error ? (
            ...
            <div className="no-results">
              <h3>{t('services.mechanic.noResults')}</h3>
